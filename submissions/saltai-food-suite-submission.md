...
- Team Orders: up to 3 days, 30 orders/week
- Corporate Accounts: up to 10 accounts
- Local Booking: up to 3 service types, 100 bookings/month
...
| Field | Value |
|-------|-------|
| App URL | https://saltai-food-suite-production.up.railway.app |
| Privacy Policy URL | https://saltai.app/privacy/saltai-food-suite |
| Support Email | hello@saltai.app |
| Category | Store management — Apps and sales channels |
| Keywords | food business Shopify, allergen compliance, food suite, food commerce bundle, restaurant Shopify apps, catering Shopify, food delivery app |

## 8. App Icon

Path: `~/Projects/saltcore-apps-brand/icons/saltai-food-suite.png`
...
- [ ] Privacy policy URL entered: https://saltai.app/privacy/saltai-food-suite
- [ ] Support email entered: hello@saltai.app
- [ ] App icon uploaded (1200×1200 PNG)
- [ ] At least 3 screenshots uploaded
- [ ] Category selected: Store management — Apps and sales channels
- [ ] Keywords entered
- [ ] App URL confirmed: https://saltai-food-suite-production.up.railway.app
...
(Find SaltAI Food Suite in the list, click Manage → Distribute → Submit for review)
